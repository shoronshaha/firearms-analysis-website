...
const Blogs = () => {
    return (
        <div className='justify-items-center mt-10 grid sm:grid-cols-1 md:grid-cols-3 '>
            <div className='rounded-lg shadow-lg bg-gray-100 max-w-sm p-5 h-[450px] w-[350px] hover:bg-blue-50 mx-2'>
                <h1 className='text-center font-black text-[20px] p-3 mt-[10]'>What is Context API ?</h1>
            ...
            <div className='rounded-lg shadow-lg bg-gray-100 max-w-sm p-5 h-[450px] w-[350px] hover:bg-blue-50 mx-2'>
                <h1 className='text-center font-black text-[20px] p-3 mt-[10]'>What is Semantic Tag?</h1>
            ...
            <div className='rounded-lg shadow-lg bg-gray-100 max-w-sm p-5 h-[450px] w-[350px] hover:bg-blue-50 mx-2'>
                <h1 className='text-center font-black text-[20px] p-3 mt-[10]'>Difference between inline block and inline block element?</h1>
